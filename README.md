...
- [Insertar Datos](#Insertar)
	- [Solicitudes](#Realizar solicitudes)
		- [Insertar_jugador](#Insertar Jugador)
		- [Insertar_rival](#Insertar rival)
		- [Insertar_partido](#Insertar partido)
		- [Insertar_gol](#Insertar gol)
		- [Insertar_tarjeta](#Insertar tarjeta)
